...
## INDIRECT函数
常用方法就是设置下拉二级菜单，例如如下表格：

| 日常运维     | 故障处理     | 工作汇报 | 技术支持 |
| ------------ | ------------ | -------- | -------- |
| 设备上架配置 | 操作系统故障 | 文档编写 | 远程支持 |
| 系统安装     | 软件故障     | 总结会议 | 文档支持 |
| 软件安装     | 硬件故障     | 日常例会 | 现场支持 |
| 系统升级     | 网络故障     | 故障汇报 |          |
| 微码升级     | 技术支持     | 其他会议 |          |
...
实现目的：
- 第一列下拉菜单选择“日常运维”时候，第二列就是下来菜单内容就是上表“日常运维列”对应的内容。

首先定义名称，作为第一列下拉菜单的选项：
- Excel菜单栏“公式”，找到“名称管理器”，点击“定义名称”
- 名称写“工作分类”
- 范围默认“工作簿”，根据自己需求来
- 引用位置：就是上表第一列的内容，“日常运维”，“故障处理”这些

然后定义第二列下拉菜单引用内容，同样是定义名称：
- Excel菜单栏“公式”，找到“名称管理器”，点击“定义名称”
- 名称：刚才定义的名称里面的内容一次添加，例如先来“日常运维”
- 范围默认“工作簿”，根据自己需求来
- 引用位置：就是“日常运维”那列里面下面的内容
- 然后依次添加“故障处理”这些

开始定义下拉菜单：
- 第一列选中一个单元格，例如是“I2“，Excel菜单栏“数据”，找到“数据验证”，点击“定义名称”
- 允许：选择序列，
- 来源：写入“=工作分类”（就是刚才定义的名称）
- 选中”J2“单元格，同样是数据验证：
- 允许：选择序列，
- 来源：写入”=INDIRECT(I2)“
...
参考链接：[总结篇--INDIRECT函数使用终极帖](https://zhuanlan.zhihu.com/p/89777934)
