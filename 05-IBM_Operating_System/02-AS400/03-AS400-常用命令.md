...
- [IBM i 7.3 CL command finder](https://www.ibm.com/docs/zh/i/7.3?topic=language-alphabetic-list-cl-commands-by-command-name)
...
DLTEXPSPLF|Delete Expired Spooled files
...
:---|:---
GO BRMS|Backup Recovery and Media Services for i5/OS
DSPLOGBRM|Display BRM Log Information
