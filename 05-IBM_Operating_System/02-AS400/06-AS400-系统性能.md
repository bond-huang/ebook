...
### QDBFSTCCOL
QDBFSTCCOL，允许后台数据库统计数据收集系统值，官方描述参考：
- [Performance system values: Allow background database statistics collection](https://www.ibm.com/docs/en/i/7.5?topic=svpo-performance-system-values-allow-background-database-statistics-collection)
- [Why is the QDBFSTCCOL Taking CPU?](https://www.ibm.com/support/pages/why-qdbfstccol-taking-cpu)
