...
## SAN B-type常用命令
官方命令参考链接：
- [Brocade Fabric OS Commands](https://techdocs.broadcom.com/us/en/fibre-channel-networking/fabric-os/fabric-os-commands/9-0-x/Fabric-OS-Commands-Chapter.html)
- [Brocade® Fabric OS® Command Reference Manual, 9.2.x](https://techdocs.broadcom.com/us/en/fibre-channel-networking/fabric-os/fabric-os-commands/9-2-x/Fabric-OS-Commands/zoneRemove.html)
