...
sed -i 's/fs.*stat = statFix(fs.*stat)/\/\/ &/g' /home/travis/.nvm/versions/node/v12.22.3/lib/node_modules/gitbook-cli/node_modules/npm/node_modules/graceful-fs/polyfills.js
gitbook install
gitbook build .
if [ $? -ne 0 ];then
    exit 1
